...
import com.ncert7.aitutorandlab.ui.screens.chatbotscreen.components.dataclass.GraphData
import com.ncert7.aitutorandlab.ui.screens.chatbotscreen.utility.GraphAudioSyncLogic
import com.ncert7.aitutorandlab.ui.screens.chatbotscreen.utility.GraphInteractionHandler
import com.ncert7.aitutorandlab.ui.screens.chatbotscreen.utility.GraphRenderLogic
import com.ncert7.aitutorandlab.ui.screens.chatbotscreen.utility.GraphUtils
...
fun ConceptMapModel(
    ...
    /**
     * Node positions map - don't reset when JSON changes, only recalculate positions
     */
    val nodePosition = remember { mutableStateMapOf<String, Offset>() }
    ...
    Box(
        ...
        Canvas(
            ...
            /**
             * Calculate node positions (recalculate when node count changes)
             */
            if (nodePosition.size != graphData.nodes.size) {
                nodePosition.clear()
