package com.ncert7.aitutorandlab.ui.screens.chatbotscreen.utility
...
class GraphAudioSyncLogic(
     ...
     */
    @Composable
    fun getVisibleNodeIds(currentSegment: GraphData.AudioSegment?): Set<String> {
     ...
     */
    @Composable
    fun getHighlightedNodeIds(currentSegment: GraphData.AudioSegment?): Set<String> {
     ...
     */
    @Composable
    fun getHighlightedEdgeIds(currentSegment: GraphData.AudioSegment?): Set<String> {
        return remember(currentSegment) {
    ...
    @Composable
    fun LogSyncState(
        currentSegment: GraphData.AudioSegment?,
