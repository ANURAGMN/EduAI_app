package com.anurag.eduai.ui.screens.conceptdetailscreen.components
...
/**
 * Header component specifically for ConceptDetailScreen
 */
@Composable
fun ConceptDetailScreenHeader(
    title: String,
    subtitle: String,
    onBackClick: () -> Unit = {},
    onGoHome: () -> Unit = {},
    ...
    Box(
        ...
        Row(
            ...
            Row {
                IconButton(
                    onClick = {
                        DebugLogger.debugLog("ConceptDetailScreenHeader", "Home button clicked")
                        onGoHome()
                    }
                ) {
                    Icon(
                ...
                IconButton(
                    onClick = {
                        DebugLogger.debugLog("ConceptDetailScreenHeader", "Settings button clicked")
                        onGoSetting()
                    }
                ) {
                    Icon(
